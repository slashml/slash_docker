...
def run_image(target_directory: str, build_dir: Path=None, tag=None, port=8080, attach=False) -> None:
    """
    ...
    #     )
    return tr.docker_run(build_dir=build_dir, tag=tag, local_port=port, detach=not attach)
